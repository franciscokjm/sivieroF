...
int touchTHRESHOLD_A0_max = 1000; //Sensibilidade de corte do sensor A0
...
int delaySens = 500; //Intervalo entre as leituras de casa sensor (ms)
int delayLoop = 200; //Intervalo entre leityras do bloco Loop (ms) default=10
